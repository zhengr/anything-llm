...
const TRANSLATIONS = {
  ...
  welcomeMessage: {
    ...
    part4:
      "Mixtao Labs 是一家专注于人工智能和机器学习领域的研发机构，致力于提供创新的技术解决方案和服务。该实验室在自然语言处理、计算机视觉、数据挖掘等方面拥有丰富的研发经验和成果，为多个行业提供智能化解决方案。",
    createWorkspace: "创建您的第一个工作区",
    user2: "请具体说说MixTAO Labs在AI领域的创新！",
    part5:
      "MixTAO Labs专注于整合强大的AI产品，如llama、mistral、gemma、phi、qwen、OpenAi、GPT-4、LangChain、CrewAI、PineconeDB和ChromaDB等，以精简成熟的架构包为企业和组织构建“智慧大脑”。通过这些先进模型的推理能力，可以显著提升特定生产力，达到持续的业绩增长。\n\n欢迎访问我们在Huggingface上的模型和演示，详情请见：https://huggingface.co/mixtao。",
    user3: "哇，这听起来很棒，让我马上试试！",
    part6: "玩得开心！",
    starOnGithub: "在 GitHub 上加星",
    contact: "联系 MixTAO Labs",
  },
